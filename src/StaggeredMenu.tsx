...
//   logoUrl = '/src/assets/logos/reactbits-gh-white.svg',
  ...
  const [menuActive, setMenuActive] = useState(false); // menu hidden by default
  ...
  useLayoutEffect(() => { 
    const ctx = gsap.context(() => {
      ...
      // Move everything offscreen and invisible immediately
      gsap.set([panel, ...preLayers], { xPercent: offscreen, opacity: 0 });

      // Keep your other GSAP sets (icon, plus lines, etc.)
